...
namespace Diver\PriceLisrBundle\Tests\Controller;
...
class CategoriesControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'diver_pricelisrbundle_categoriestype[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Edit')->form(array(
            'diver_pricelisrbundle_categoriestype[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
